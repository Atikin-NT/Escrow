 ...
 * @param  {float} fee
 * @param  {int} feeRole
 * @returns {createJsonAnswer|null}
 */
exports.dbInsertDataCheck = (buyer, seller, value, sellerIsAdmin, fee, feeRole) => {
    if(value == null || buyer == null || seller == null){
 ...
 * @returns {createJsonAnswer|null}
 */
exports.dbGetDealsByAccountCheck = (account) => {
    if(account == null)
 ...
 * @returns {createJsonAnswer|null}
 */
exports.dbGetDealsByIDCheck = (id) => {
 ...
 * @returns {createJsonAnswer|null}
 */
exports.dbUpdateDealStatusCheck = (txId, status) => {
    if(txId == null || status == null || typeof(status) != "number")
    ...
    if(status < DEAL_STATUS.CREATE || status > DEAL_STATUS.FINISHED)
 ...
 * @returns {createJsonAnswer|null}
 */
exports.dbsetTxIdCheck = (id, txId) => {
    if((typeof(id) != "number" && typeof(id) != "string") || id == null || id == undefined)
