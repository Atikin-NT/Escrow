...
function dbInsertDataCheck(buyer, seller, value){
    if(value == null || buyer == null || seller == null || (typeof(value) != "number" && typeof(value) != "string")){
    ...
    if (typeof value == "string" && !value.startsWith('BIGINT::') && BigInt(value.substr(8)) <= 0) {
        return createJsonAnswer(613, 'Value is invalid (value <= 0)');
    }
    return null;
}
